...
import dungeonmania.entities.Withdrawable;
...
public class GameMap {
    ...
    private void triggerMovingAwayEvent(Entity entity) {
        ...
        for (Entity e : getEntities(entity.getPosition())) {
            if (e != entity && e instanceof Withdrawable) {
                Withdrawable withdraw = (Withdrawable) e;
                callbacks.add(() -> withdraw.onMovedAway(this, entity));
            }
        }
    ...
    public void destroyEntity(Entity entity) {
        ...
        if (entity instanceof Destructible) {
            Destructible destructable = (Destructible) entity;
            destructable.onDestroy(this);
        }
    }
