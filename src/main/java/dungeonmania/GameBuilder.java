...
import dungeonmania.util.MazeGenerator;
...
public class GameBuilder {
    ...
    public Game generateGame(Integer xStart, Integer yStart, Integer xEnd, Integer yEnd) {
        this.dungeonName = "Generated dungeon";
        loadConfig();
        writeDungeon(xStart, yStart, xEnd, yEnd);
        if (dungeon == null && config == null) {
            return null; // something went wrong
        }
        Game game = new Game(dungeonName);
    ...
    public void writeDungeon(Integer xStart, Integer yStart, Integer xEnd, Integer yEnd) {
        MazeGenerator mzGen = new MazeGenerator(xStart, yStart, xEnd, yEnd);
        mzGen.generateMaze();
        dungeon = mzGen.generateJSONDungeon();
    }
