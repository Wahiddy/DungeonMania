...
public class DungeonManiaController {
     ...
     *
     */
    public DungeonResponse generateGame(Integer xStart, Integer yStart, Integer xEnd, Integer yEnd, String configName)
        ...
        try {
            ...
            game = builder.setConfigName(configName).generateGame(xStart, yStart, xEnd, yEnd);
            return ResponseBuilder.getDungeonResponse(game);
        } catch (JSONException e) {
            return null;
        }
