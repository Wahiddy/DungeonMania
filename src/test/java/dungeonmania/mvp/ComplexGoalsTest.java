...
public class ComplexGoalsTest {
    ...
    @Test
    @Tag("14-7")
    @DisplayName("Testing conjunction of EXIT and ENEMIES goals")
    public void exitAndEnemies() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_complexGoalsTest_exitAndEnemies", "c_complexGoalsTest_exitAndEnemies");
    ...
    @Test
    @Tag("14-8")
    @DisplayName("Testing conjunction of TREASURE or ENEMIES goals")
    public void treasureOrEnemies() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_complexGoalsTest_treasureOrEnemies",
                "c_complexGoalsTest_treasureOrEnemies");
