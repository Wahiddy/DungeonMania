...
export const API = {
  ...
  generateGame: (xStart: integer, yStart: integer, xEnd: integer, yEnd: integer, configName: string): Promise<Dungeon | null> =>
    evaluateResponse(
      axios.post(
      ...
      "Error POST /game/generate: DungeonManiaController::ctor(...)",
      null
    ),
